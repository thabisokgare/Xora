        ...
        <header className="fixed top-0 left-0 z-50 w-full py-10">
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                <div className={clsx('w-full  max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:opacity-0', isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')} >
                    <div
                        className="w-full max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
                        <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
                            <ul className="flex max-lg:block max-lg:px-12">
                                ...
                                <li className="nav-logo">
                                    ...
                                    to="hero"
                                    offest={-100}
                                    spy smooth className={clsx("max-lg:hidden transition-transform duration-500")}>
